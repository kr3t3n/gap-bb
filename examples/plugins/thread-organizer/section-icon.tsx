...
import type { SectionIconName } from "./core.js";
...
} as const satisfies Record<SectionIconName, IconSvgElement>;

export function sectionIconLabel(name: SectionIconName): string {
  return name
